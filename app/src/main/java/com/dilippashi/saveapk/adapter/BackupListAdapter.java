package com.dilippashi.saveapk.adapter;
...
public class BackupListAdapter extends BaseAdapter {
    ...
    private List<BackupModel> original_items;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.txt_title = convertView.findViewById(R.id.name);
            holder.txt_version = convertView.findViewById(R.id.version);
            holder.txt_size = convertView.findViewById(R.id.size);
            holder.image = convertView.findViewById(R.id.image);
            holder.lyt_flag = convertView.findViewById(R.id.lyt_flag);
