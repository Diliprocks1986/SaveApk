...
import static com.dilippashi.saveapk.utils.WifiUtils.connectToOpenHotspot;
...
public class ReceiverActivity extends AppCompatActivity {
    ...
    private void connectToWifi(String ssid) {
        ...
        if (resetWifiScan) {
            ...
            Message message = m_wifiScanHandler.obtainMessage(WifiTasksHandler.WAIT_FOR_CONNECT_ACTION_TIMEOUT);
            message.obj = ssid;
...
//                R.anim.push_right_in, R.anim.push_right_out);
    ...
    private class WifiScanner extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (Objects.requireNonNull(intent.getAction()).equals(WifiManager.SCAN_RESULTS_AVAILABLE_ACTION) && !WifiUtils.isWifiConnectedToSTAccessPoint(getApplicationContext())) {
