package com.dilippashi.saveapk.receiver;
...
public class FilesListingFragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        @SuppressLint("InflateParams") View v = inflater.inflate(R.layout.fragment_files_listing, null);
    ...
    private void postDownloadRequestToDM(Uri uri, String fileName) {
    ...
    private class SenderFilesListingAdapter extends RecyclerViewArrayAdapter<String, SenderFilesListItemHolder> {
        ...
        @NonNull
        @Override
        public SenderFilesListItemHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        @Override
        public void onBindViewHolder(@NonNull SenderFilesListItemHolder holder, int position) {
