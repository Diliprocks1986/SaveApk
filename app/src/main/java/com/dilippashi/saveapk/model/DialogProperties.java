...
package com.dilippashi.saveapk.model;
...
public class DialogProperties {
    ...
    public DialogProperties() {
        selection_mode = com.dilippashi.saveapk.model.DialogConfigs.SINGLE_MODE;
        selection_type = com.dilippashi.saveapk.model.DialogConfigs.FILE_SELECT;
        root = new File(com.dilippashi.saveapk.model.DialogConfigs.DEFAULT_DIR);
        error_dir = new File(com.dilippashi.saveapk.model.DialogConfigs.DEFAULT_DIR);
