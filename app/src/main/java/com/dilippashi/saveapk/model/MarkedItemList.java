...
public class MarkedItemList {
    private static HashMap<String, com.dilippashi.saveapk.model.FileListItem> ourInstance = new HashMap<>();

    public static void addSelectedItem(com.dilippashi.saveapk.model.FileListItem item) {
