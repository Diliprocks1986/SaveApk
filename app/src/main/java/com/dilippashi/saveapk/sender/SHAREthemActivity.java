package com.dilippashi.saveapk.sender;
...
import com.dilippashi.saveapk.utils.DividerItemDecoration;
import com.dilippashi.saveapk.utils.HotspotControl;
import com.dilippashi.saveapk.utils.RecyclerViewArrayAdapter;
import com.dilippashi.saveapk.utils.Utils;
import com.dilippashi.saveapk.utils.WifiUtils;
...
import static com.dilippashi.saveapk.utils.Utils.getRandomColor;
...
//            m_receiversListAdapter.remove(new WifiApControl.Client(ip, null, null));
    ...
    private static class ReceiversListingAdapter extends RecyclerViewArrayAdapter<HotspotControl.WifiScanResult, ReceiversListItemHolder> {
        ...
        @NonNull
        @Override
        public ReceiversListItemHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            if (null != sharedFiles && sharedFiles.length > 0)
                for (String sharedFile : sharedFiles) {
                    ...
                    statusView.setTag(sharedFile.substring(sharedFile.lastIndexOf('/') + 1, sharedFile.length()));
        ...
        @Override
        public void onBindViewHolder(@NonNull ReceiversListItemHolder holder, int position) {
